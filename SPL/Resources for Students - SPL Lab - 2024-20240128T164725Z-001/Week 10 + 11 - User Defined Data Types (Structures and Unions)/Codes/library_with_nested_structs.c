       ...
       if(l[i].quantity>0)
        {
            ...
            scanf("%d",&l[i].p.contact_no);
            printf("\n\nChecked out Successfully to '%s', address: %s, email: %s, contact num: %d!!\n\n", l[i].p.name, l[i].p.address,l[i].p.email,l[i].p.contact_no);
        }
